...
uchar COLOR_blue_low[3] = {110, 30, 30}; 
// High hsv values for blue values.
uchar COLOR_blue_high[3] = {130, 255, 255}; 
// Low hsv values for green colors.
uchar COLOR_green_low[3] = {40, 60, 60}; 
// High hsv values for green values.
uchar COLOR_green_high[3] = {70, 255, 255}; 
// Low hsv values for orange colors.
uchar COLOR_orange_low[3] = {15, 100, 100};
// High hsv values for orange values.
uchar COLOR_orange_high[3] = {20, 255, 255}; 
// Low hsv values for purple colors.
uchar COLOR_purple_low[3] = {140, 100, 100};
// High hsv values for purple values.
uchar COLOR_purple_high[3] = {160, 255, 255};
// Low hsv values for black colors.
uchar COLOR_black_low[3] = {0, 0, 0};
// High hsv values for black values.
uchar COLOR_black_high[3] = {180, 230, 30};
// Low hsv values for yellow colors.
uchar COLOR_yellow_low[3] = {25, 100, 100};
// High hsv values for yellow values.
uchar COLOR_yellow_high[3] = {45, 255, 255};
// Low hsv values for red_low colors.
// uchar COLOR_red_low_low[3] = {0, 100, 100};
// // High hsv values for red_low values.
// uchar COLOR_red_low_high[3] = {10, 255, 255};
// // // Low hsv values for red_high colors.
// // uchar COLOR_red_high_low[3] = {160, 100, 100};
// // // High hsv values for red_high values.
// // uchar COLOR_red_high_high[3] = {179, 255, 255};
...
void ImageCallBack(const sensor_msgs::Image &msg)
{
  ...
  GetPosition(head, COLOR_black_low, COLOR_black_high, 2);
  for(int i = 0; i != NUM_OBJ; i++)
  {
    // Assign values to pose and add offsets (in cm) to get the position 
    // in the baxter coordinate system (green).
  ...
  GetPosition(head, COLOR_yellow_low, COLOR_yellow_high, 2);
  for(int i = 0; i != NUM_OBJ; i++)
  {
    // Assign values to pose and add offsets (in cm) to get the position 
    // in the baxter coordinate system (green).
